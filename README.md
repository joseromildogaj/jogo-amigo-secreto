...
## Descrição
Esse repositório apresenta o desenvolvimento de uma aplicação que permita aos usuários inserir nomes de amigos em uma lista para, em seguida, realizar um sorteio aleatório e determinar quem é o "amigo secreto".
...
- *Validar entrada:* Se o campo de texto estiver vazio ou com um valor inválido, o programa exibirá um alerta solicitando um nome válido.
...
1.  **Clone o repositório:**
    ...
    ```bash
    git clone git@github.com:joseromildogaj/jogo-amigo-secreto.git
    ```
...
3.  **Abra o arquivo HTML principal:**
    ...
    Localize o arquivo HTML principal do seu projeto (geralmente `index.html`) no explorador de arquivos do VS Code e abra-o.
